...
def prLightPurple(prt): print("\033[94m {}\033[00m".format(prt), flush=True)


def prPurple(prt): print("\033[95m {}\033[00m".format(prt), flush=True)
...
def prBlack(prt): print("\033[98m {}\033[00m".format(prt), flush=True)
