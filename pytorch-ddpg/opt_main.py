...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='simple', choices=('simple', 'mnist', 'nonconvex_easy', 'nonconvex_medium', 'nonconvex_hard') + tuple(envs.keys()))
    ...
    env = LearnedOptimizationEnv(1000, args.grad_batch_size, args.ndim, 1, 20000, args.nlosses, args.ngradients,
